...
\@x{ {\VARIABLES} i ,\, pc}%
\@pvspace{8.0pt}%
\@x{ init\@s{7.15} \.{\defeq} ( pc \.{=}\@w{start} ) \.{\land} ( i \.{=} 0 )}%
\@pvspace{8.0pt}%
...
\@x{\@s{50.26} \.{\land} i \.{'} \.{=} i \.{+} 1}%
\@x{\@s{50.26} \.{\land} pc \.{'} \.{=}\@w{done}}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Sep} 15
 12:07:46 \ensuremath{EDT} 2019 by \ensuremath{Ani
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Sep} 15 12:01:56
 \ensuremath{EDT} 2019 by \ensuremath{Ani
}%
\end{cpar}%
\end{lcom}%
\end{document}
