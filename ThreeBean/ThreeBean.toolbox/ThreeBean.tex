...
\@x{}\moduleLeftDash\@xx{ {\MODULE} ThreeBean}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@x{ {\CONSTANTS} M ,\, N ,\, O}%
\@x{ {\ASSUME} \.{\land} M \.{\in} 1 \.{\dotdot} 100}%
\@x{\@s{38.24} \.{\land} N\@s{1.53} \.{\in} 1 \.{\dotdot} 100}%
\@x{\@s{38.24} \.{\land} O\@s{1.99} \.{\in} 1 \.{\dotdot} 100}%
\@x{\@s{38.24} \.{\land} M \.{+} N \.{+} O \.{>} 0}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmfair} {\p@algorithm} ThreebeansAlg {\p@lbrace}}%
 \@x{\@s{12.29} {\p@variable} r \.{=} M ,\, g \.{=} N ,\, b \.{=} O
 {\p@semicolon}}%
 \@x{\@s{8.2} {\p@lbrace} S\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen}}%
\@x{\@s{30.88} {\p@lbrace} {\p@either}}%
\@x{\@s{34.98} {\p@lbrace} {\p@await} ( r \.{>} 1 ) {\p@semicolon}}%
\@y{\@s{0}%
 \ensuremath{\.{\,\backslash\,}}* same color and red
}%
\@xx{}%
\@x{\@s{56.86} r \.{:=} r \.{-} 2 {\p@semicolon}}%
\@x{\@s{56.86} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{44.56} {\p@or}}%
\@x{\@s{30.88} {\p@lbrace} {\p@await} ( g \.{>} 1 ) {\p@semicolon}}%
\@y{\@s{0}%
 \ensuremath{\.{\,\backslash\,}}* same color and green
}%
\@xx{}%
\@x{\@s{56.86} g \.{:=} g \.{-} 2\@s{1.24} {\p@semicolon}}%
\@x{\@s{52.76} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{44.56} {\p@or}}%
\@x{\@s{30.88} {\p@lbrace} {\p@await} ( b \.{>} 1 ) {\p@semicolon}\@s{0.25}}%
\@y{\@s{0}%
 \ensuremath{\.{\,\backslash\,}}* same color and blue
}%
\@xx{}%
\@x{\@s{56.86} b \.{:=} b \.{-} 2\@s{1.49} {\p@semicolon}}%
\@x{\@s{56.86} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{44.56} {\p@or}}%
 \@x{\@s{30.88} {\p@lbrace} {\p@await} ( r \.{>} 0 \.{\land} g \.{>} 0 )
 {\p@semicolon}}%
\@y{\@s{0}%
 \ensuremath{\.{\,\backslash\,}}* one red and one green
}%
\@xx{}%
\@x{\@s{60.96} r\@s{0.19} \.{:=} r\@s{0.19} \.{-} 1 {\p@semicolon}}%
\@x{\@s{60.96} g \.{:=} g \.{-} 1 {\p@semicolon}}%
\@x{\@s{60.96} b\@s{0.25} \.{:=} b\@s{0.25} \.{+} 1 {\p@semicolon}}%
\@x{\@s{60.96} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{44.56} {\p@or}}%
 \@x{\@s{21.88} {\p@lbrace} {\p@await} ( g \.{>} 0 \.{\land} b \.{>} 0 )
 {\p@semicolon}}%
\@y{\@s{0}%
 \ensuremath{\.{\,\backslash\,}}* one blue and one green
}%
\@xx{}%
\@x{\@s{51.96} g \.{:=} g \.{-} 1 {\p@semicolon}}%
\@x{\@s{51.96} b\@s{0.25} \.{:=} b\@s{0.25} \.{-} 1 {\p@semicolon}}%
\@x{\@s{51.96} r\@s{0.19} \.{:=} r\@s{0.19} \.{+} 1 {\p@semicolon}}%
\@x{\@s{51.96} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{39.66} {\p@or}}%
 \@x{\@s{21.88} {\p@lbrace} {\p@await} ( b \.{>} 0 \.{\land} r \.{>} 0 )
 {\p@semicolon}\@s{0.19}}%
\@y{\@s{0}%
 \ensuremath{\.{\,\backslash\,}}* one blue and one red
}%
\@xx{}%
\@x{\@s{51.96} b\@s{0.25} \.{:=} b \.{-} 1 {\p@semicolon}}%
\@x{\@s{51.96} r\@s{0.19} \.{:=} r\@s{0.19} \.{-} 1 {\p@semicolon}}%
\@x{\@s{51.96} g \.{:=} g \.{+} 1 {\p@semicolon}}%
\@x{\@s{47.86} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{35.56} {\p@rbrace}}%
\@x{\@s{21.88} {\p@rbrace}}%
\@x{\@s{17.78} {\p@rbrace}}%
\@y{}%
...
\@x{ {\VARIABLES} r ,\, g ,\, b}%
\@pvspace{8.0pt}%
\@x{ vars\@s{2.10} \.{\defeq} {\langle} r ,\, g ,\, b {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{4.12} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{39.83} \.{\land} r\@s{0.19} \.{=} M}%
\@x{\@s{39.83} \.{\land} g \.{=} N}%
\@x{\@s{39.83} \.{\land} b\@s{0.25} \.{=} O}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \.{\lor} \.{\land} ( r \.{>} 1 )}%
\@x{\@s{50.94} \.{\land} r \.{'}\@s{0.19} \.{=} r \.{-} 2}%
\@x{\@s{50.94} \.{\land} b \.{'}\@s{0.25} \.{=} b}%
\@x{\@s{50.94} \.{\land} g \.{'} \.{=} g}%
\@x{\@s{39.83} \.{\lor} \.{\land} ( g \.{>} 1 )}%
\@x{\@s{50.94} \.{\land} g \.{'} \.{=} g \.{-} 2}%
\@x{\@s{50.94} \.{\land} r \.{'}\@s{0.19} \.{=} r}%
\@x{\@s{50.94} \.{\land} b \.{'}\@s{0.25} \.{=} b}%
\@x{\@s{39.83} \.{\lor} \.{\land} ( b \.{>} 1 )}%
\@x{\@s{50.94} \.{\land} b \.{'}\@s{0.25} \.{=} b \.{-} 2}%
\@x{\@s{50.94} \.{\land} r \.{'}\@s{0.19} \.{=} r}%
\@x{\@s{50.94} \.{\land} g \.{'} \.{=} g}%
\@x{\@s{39.83} \.{\lor} \.{\land} ( r\@s{0.19} \.{>} 0 \.{\land} g \.{>} 0 )}%
\@x{\@s{50.94} \.{\land} r \.{'}\@s{1.27} \.{=} r\@s{0.19} \.{-} 1}%
\@x{\@s{50.94} \.{\land} g \.{'}\@s{1.08} \.{=} g \.{-} 1}%
\@x{\@s{50.94} \.{\land} b \.{'}\@s{1.33} \.{=} b\@s{0.25} \.{+} 1}%
\@x{\@s{39.83} \.{\lor} \.{\land} ( g \.{>} 0 \.{\land} b \.{>} 0 )}%
\@x{\@s{50.94} \.{\land} r \.{'}\@s{1.27} \.{=} r\@s{0.19} \.{+} 1}%
\@x{\@s{50.94} \.{\land} g \.{'}\@s{1.08} \.{=} g \.{-} 1}%
\@x{\@s{50.94} \.{\land} b \.{'}\@s{1.33} \.{=} b\@s{0.25} \.{-} 1}%
\@x{\@s{39.83} \.{\lor} \.{\land} ( r\@s{0.19} \.{>} 0 \.{\land} b \.{>} 0 )}%
\@x{\@s{50.94} \.{\land} r \.{'}\@s{1.27} \.{=} r\@s{0.19} \.{-} 1}%
\@x{\@s{50.94} \.{\land} g \.{'}\@s{1.08} \.{=} g \.{+} 1}%
\@x{\@s{50.94} \.{\land} b \.{'}\@s{1.33} \.{=} b\@s{0.25} \.{-} 1}%
...
\@y{\@s{0}%
 \ensuremath{\.{\land} r \.{\in} 0\.{\dotdot}100
}}%
\@xx{}%
\@x{\@s{60.24}}%
\@y{\@s{0}%
 \ensuremath{\.{\land} g \.{\in} 0\.{\dotdot}100
}}%
\@xx{}%
\@x{\@s{60.24}}%
\@y{\@s{0}%
 \ensuremath{\.{\land} b \.{\in} 0\.{\dotdot}100
}}%
\@xx{}%
\@x{\@s{60.24} r \.{+} g \.{+} b \.{>} 0}%
\@x{ NonTermination \.{\defeq} r \.{+} g \.{+} b \.{>} 1}%
\@x{ Termination \.{\defeq} {\Diamond} ( r \.{+} g \.{+} b \.{<} 2 )}%
\@pvspace{16.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Sep} 16 12:18:22 \ensuremath{EDT} 2019 by \ensuremath{Ani
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Sep} 16
 11:43:50 \ensuremath{EDT} 2019 by \ensuremath{Ani
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
Each bean is either red, blue or green. The can is initially
 nonempty (\ensuremath{r\.{+}g\.{+}b\.{>}0}). Now consider the following
 program:
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
