...
\@x{}\moduleLeftDash\@xx{ {\MODULE} beansAlg}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@x{ {\CONSTANTS} M ,\, N}%
\@x{ {\ASSUME} \.{\land} M \.{\in} 1 \.{\dotdot} 100}%
\@x{\@s{38.24} \.{\land} N\@s{1.53} \.{\in} 1 \.{\dotdot} 100}%
\@x{\@s{38.24} \.{\land} M \.{+} N \.{>} 0}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmfair} {\p@algorithm} beansAlg {\p@lbrace}}%
\@x{\@s{12.29} {\p@variable} w \.{=} M ,\, b \.{=} N {\p@semicolon}}%
 \@x{\@s{8.2} {\p@lbrace} S\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen}}%
\@x{\@s{30.88} {\p@lbrace} {\p@either}}%
\@x{\@s{34.98} {\p@lbrace} {\p@await} ( w \.{>} 1 ) {\p@semicolon}}%
\@y{\@s{0}%
 \ensuremath{\.{\,\backslash\,}}* same color and white
}%
\@xx{}%
\@x{\@s{56.86} w \.{:=} w \.{-} 1 {\p@semicolon}}%
\@x{\@s{56.86} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{44.56} {\p@or}}%
\@x{\@s{30.88} {\p@lbrace} {\p@await} ( b \.{>} 1 ) {\p@semicolon}}%
\@y{\@s{0}%
 \ensuremath{\.{\,\backslash\,}}* same color and black
}%
\@xx{}%
 \@x{\@s{56.86} b \.{:=} b \.{-} 2\@s{1.49} {\p@semicolon} w \.{:=} w \.{+} 1
 {\p@semicolon}}%
\@x{\@s{52.76} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{44.56} {\p@or}}%
 \@x{\@s{21.88} {\p@lbrace} {\p@await} ( w \.{>} 0 \.{\land} b \.{>} 0 )
 {\p@semicolon}}%
\@y{\@s{0}%
 \ensuremath{\.{\,\backslash\,}}* different color
}%
\@xx{}%
\@x{\@s{51.96} w \.{:=} w \.{-} 1 {\p@semicolon}}%
...
\@x{ {\VARIABLES} w ,\, b}%
\@pvspace{8.0pt}%
\@x{ vars\@s{2.10} \.{\defeq} {\langle} w ,\, b {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{4.12} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{39.83} \.{\land} w \.{=} M}%
\@x{\@s{39.83} \.{\land} b\@s{2.48} \.{=} N}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \.{\lor} \.{\land} ( w \.{>} 1 )}%
\@x{\@s{50.94} \.{\land} w \.{'} \.{=} w \.{-} 1}%
\@x{\@s{50.94} \.{\land} b \.{'}\@s{2.48} \.{=} b}%
\@x{\@s{39.83} \.{\lor} \.{\land} ( b \.{>} 1 )}%
\@x{\@s{50.94} \.{\land} b \.{'}\@s{2.48} \.{=} b\@s{2.48} \.{-} 2}%
\@x{\@s{50.94} \.{\land} w \.{'} \.{=} w \.{+} 1}%
\@x{\@s{39.83} \.{\lor} \.{\land} ( w \.{>} 0 \.{\land} b \.{>} 0 )}%
\@x{\@s{50.94} \.{\land} w \.{'} \.{=} w \.{-} 1}%
\@x{\@s{50.94} \.{\land} b \.{'}\@s{2.48} \.{=} b}%
\@pvspace{8.0pt}%
...
\@y{\@s{0}%
 \ensuremath{\.{\land} w \.{\in} 0\.{\dotdot}100
}}%
\@xx{}%
\@x{\@s{60.24}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{60.24} w \.{+} b \.{>} 0}%
\@x{ NonTermination \.{\defeq} w \.{+} b \.{>} 1}%
\@x{ Termination \.{\defeq} {\Diamond} ( w \.{+} b \.{<} 2 )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
Each bean is either white or black. The can is initially
 nonempty (\ensuremath{w\.{+}b\.{>}0}). Now consider the following program:
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
